              ...
              <div class="box">
                ...
                <hr>
                  <div class="form-group">
                    ...
                    <input id="name" type="text" class="form-control" id="name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="text-center">
                      <button type="button" onclick="registerNewUser();" class="btn btn-primary"><i class="fa fa-user-md"></i> Register</button>
                  </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="box">
                ...
                <hr>
                  <div class="form-group">
                    <label for="email">Email</label>
                    <input id="log_email" type="text" class="form-control">
                  </div>
                  <div class="form-group">
                    <label for="password">Password</label>
                  ...
                  <div class="text-center">
                      ...
                      <button type="button" <?php if(empty($userid)){ ''; }else{ echo'disabled'; }  ?> onclick="loginUser();" class="btn btn-primary"><i class="fa fa-sign-in"></i> Log in</button>
                  </div>
              </div>
            </div>
          </div>
